...
- **Volume Booster + EQ** - Boost volume up to 150% with equalizer presets (Bass Boost, Rock, Pop, etc.)
...
│   │   └── admin.js          # Admin user approval endpoints
│   └── services/
...
│       │   ├── LibraryScreen.js
│       │   ├── PlayerScreen.js
│       │   ├── GroupSessionScreen.js
│       │   └── VolumeBoosterScreen.js
│       ├── components/
│       │   ├── MiniPlayer.js
│       │   └── SongCard.js
│       ├── services/
